...
describe Cask::Cmd::Info, :cask do
  ...
  it "displays some nice info about the specified Cask" do
    expect {
      ...
      Not installed
      From: https://github.com/cerisola/homebrew-cask/blob/HEAD/Casks/local-transmission.rb
      ==> Name
      Transmission
      ==> Description
      BitTorrent client
  ...
  it "prints auto_updates if the Cask has `auto_updates true`" do
    expect {
      ...
      Not installed
      From: https://github.com/cerisola/homebrew-cask/blob/HEAD/Casks/with-auto-updates.rb
      ==> Name
      AutoUpdates
      ==> Description
      None
  ...
  describe "given multiple Casks" do
    let(:expected_output) {
      <<~EOS
        ...
        https://brew.sh/
        Not installed
        From: https://github.com/cerisola/homebrew-cask/blob/HEAD/Casks/local-caffeine.rb
        ==> Name
        None
        ==> Description
        None
  ...
  it "prints caveats if the Cask provided one" do
    expect {
      ...
      https://brew.sh/
      Not installed
      From: https://github.com/cerisola/homebrew-cask/blob/HEAD/Casks/with-caveats.rb
      ==> Name
      None
      ==> Description
      None
  ...
  it 'does not print "Caveats" section divider if the caveats block has no output' do
    expect {
      ...
      https://brew.sh/
      Not installed
      From: https://github.com/cerisola/homebrew-cask/blob/HEAD/Casks/with-conditional-caveats.rb
      ==> Name
      None
      ==> Description
      None
  ...
  it "prints languages specified in the Cask" do
    expect {
      ...
      https://brew.sh/
      Not installed
      From: https://github.com/cerisola/homebrew-cask/blob/HEAD/Casks/with-languages.rb
      ==> Name
      None
      ==> Description
      None
  ...
  it 'does not print "Languages" section divider if the languages block has no output' do
    expect {
      ...
      https://brew.sh/
      Not installed
      From: https://github.com/cerisola/homebrew-cask/blob/HEAD/Casks/without-languages.rb
      ==> Name
      None
      ==> Description
      None
