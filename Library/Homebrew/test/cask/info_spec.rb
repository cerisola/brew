...
RSpec.describe Cask::Info, :cask do
  ...
  it "prints auto_updates if the Cask has `auto_updates true`" do
    expect do
      ...
      Not installed
      From: https://github.com/cerisola/homebrew-cask/blob/HEAD/Casks/w/with-auto-updates.rb
      ==> Name
      AutoUpdates
      ==> Description
      None
  ...
  it "prints caveats if the Cask provided one" do
    expect do
      ...
      https://brew.sh/
      Not installed
      From: https://github.com/cerisola/homebrew-cask/blob/HEAD/Casks/w/with-caveats.rb
      ==> Name
      None
      ==> Description
      None
  ...
  it "prints languages specified in the Cask" do
    expect do
      ...
      https://brew.sh/
      Not installed
      From: https://github.com/cerisola/homebrew-cask/blob/HEAD/Casks/w/with-languages.rb
      ==> Name
      None
      ==> Description
      None
  ...
  it 'does not print "Languages" section divider if the languages block has no output' do
    expect do
      ...
      https://brew.sh/
      Not installed
      From: https://github.com/cerisola/homebrew-cask/blob/HEAD/Casks/w/without-languages.rb
      ==> Name
      None
      ==> Description
      None
