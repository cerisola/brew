...
module Cask
  class Audit
    ...
    def check_hosting_with_appcast
      ...
      add_appcast = "please add an appcast. See https://github.com/cerisola/homebrew-cask/blob/HEAD/doc/cask_language_reference/stanzas/appcast.md"
    ...
    def check_download_url_format
      ...
      if bad_sourceforge_url?
        add_warning "SourceForge URL format incorrect. See https://github.com/cerisola/homebrew-cask/blob/HEAD/doc/cask_language_reference/stanzas/url.md#sourceforgeosdn-urls"
      elsif bad_osdn_url?
        add_warning "OSDN URL format incorrect. See https://github.com/cerisola/homebrew-cask/blob/HEAD/doc/cask_language_reference/stanzas/url.md#sourceforgeosdn-urls"
      end
    end
