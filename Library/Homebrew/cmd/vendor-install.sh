...
then
  ...
  then
    ...
    ruby_URL2="https://github.com/cerisola/homebrew-portable-ruby/releases/download/2.6.3/portable-ruby-2.6.3.mavericks.bottle.tar.gz"
...
then
  case "$HOMEBREW_PROCESSOR" in
    x86_64)
      ...
      ruby_URL2="https://github.com/cerisola/homebrew-portable-ruby/releases/download/2.6.3/portable-ruby-2.6.3.x86_64_linux.bottle.tar.gz"
    ...
    aarch64)
      ...
      ruby_URL2="https://github.com/cerisola/homebrew-portable-ruby/releases/download/2.6.3/portable-ruby-2.6.3.aarch64_linux.bottle.tar.gz"
    ...
    armv[67]*)
      ...
      ruby_URL2="https://github.com/cerisola/homebrew-portable-ruby/releases/download/2.6.3/portable-ruby-2.6.3.armv6_linux.bottle.tar.gz"
